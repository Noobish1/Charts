...
open class ChartUtils
{
    ...
    internal class func drawMultilineText(context: CGContext, text: String, knownTextSize: CGSize, point: CGPoint, attributes: [NSAttributedStringKey : Any]?, anchor: CGPoint, angleRadians: CGFloat)
    {
    ...
    internal class func drawMultilineText(context: CGContext, text: String, point: CGPoint, attributes: [NSAttributedStringKey : Any]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat)
    {
        ...
        drawMultilineText(context: context, text: text, knownTextSize: rect.size, point: point, attributes: attributes, anchor: anchor, angleRadians: angleRadians)
    }

    private class func generateDefaultValueFormatter() -> ValueFormatterProtocol
    {
    ...
    open class func defaultValueFormatter() -> ValueFormatterProtocol
    {
